...
DROP TABLE "MANAGEMEBT" CASCADE CONSTRAINTS;
...
CREATE TABLE "INVENTORY" (
	"INVEN_CODE"	VARCHAR2(20)	NOT NULL    PRIMARY KEY,
...
-------------------------- 품목관리 --------------------------
-------------------------------------------------------------
CREATE TABLE "MANAGEMEBT" (
	"CAR_NAME"	VARCHAR2(30)		NOT NULL,
	"INVEN_CODE"	VARCHAR2(20)		NOT NULL,
    CONSTRAINT PK_MANAGEMEBT PRIMARY KEY(CAR_NAME, INVEN_CODE)
);

COMMENT ON COLUMN "MANAGEMEBT"."CAR_NAME" IS '차량이름';
COMMENT ON COLUMN "MANAGEMEBT"."INVEN_CODE" IS '부품코드';
